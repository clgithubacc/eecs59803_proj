...
classes = ['Button', 'CheckBox', 'Chronometer', 'EditText', 'ImageButton', 'ImageView',
                  'ProgressBar', 'RadioButton', 'RatingBar', 'SeekBar', 'Spinner', 'Switch',
                  'ToggleButton', 'VideoView', 'TextView']  + ['Image', 'Icon', 'Text', 'Input']
    ...
    for g in (0, 128, 255):
        for r in (0, 128, 255):
            if class_i<len(classes):
                color_map[classes[class_i]] = (b,g,r)
            else:
                break
            class_i += 1
